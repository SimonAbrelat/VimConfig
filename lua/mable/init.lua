...
vim.keymap.set("n", "<leader>p", '"_dP', { desc = "Do not override paste buffer" })
...
require("lazy").setup({
	...
	{ -- Collection of various small independent plugins/modules
		...
		init = function()
			...
			local schemes = require("mable.colors.rosepine")
			require("mini.base16").setup({ palette = schemes.rosepine })
		end,
		config = function()
			...
			-- Simple and easy highlighting for comments or hex values
